<div class="row" id="biografiBooks">
			...
			<div class="col-lg-4 col-md-6 col-sm-6 mt-sm-5" v-for="book in filterbooks" :key="book.name">
				<div class="listContent py-lg-0 py-md-5 h-100">
					<a href="<?php echo base_url();?>assets/img/menu/biografi/7-01.png">
						<?php echo "<img class='w-100 shadow rounded' src='".base_url().'assets/img/menu/biografi/'.$rowBook->foto."'>";?>
					</a>
					<hr>
						<div style="color: #F71C1C; text-align: justify-all;" class="container py-3">
							<table class="table table-sm table-borderless">
								<tr>
									<th colspan="3"><h4><?php echo "<a class='portfolio-box' href='biografi/".$rowBook->id."'>"; ?> <?php echo $rowBook->judul; ?> </a></h4></th>
								</tr>
								<tr>
									<td>Penulis</td>
									<td> : </td>
